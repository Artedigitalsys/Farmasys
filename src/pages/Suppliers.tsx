...
const Suppliers = () => {
  ...
  const canManageSuppliers = hasPermission('medications.manage');
  ...
  const confirmDeleteSupplier = () => {
    if (confirmDelete) {
      setSuppliers(prev => prev.filter(supplier => supplier.id !== confirmDelete));
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (currentSupplier) {
      ...
      setSuppliers(prev => [...prev, { id: newId, ...formData }]);
  ...
  const columns = [
    { header: 'Nome', accessor: 'name' as keyof Supplier },
    { 
      header: 'Status', 
      accessor: 'active' as keyof Supplier,
  ...
  const supplierActions = (supplier: Supplier) => (
